...
const projects = [
  { id: 1, title: 'Complete Roof Replacement', location: 'Southampton, PA', category: 'roofing' as const, detail: 'Architectural Shingles', image: '/images/project-1.webp' },
  { id: 2, title: 'Vinyl Siding Transformation', location: 'Cherry Hill, NJ', category: 'siding' as const, detail: 'Vinyl Siding', image: '/images/project-2.webp' },
  { id: 3, title: 'Hail Damage Repair', location: 'Wilmington, DE', category: 'storm' as const, detail: 'Insurance Claim', image: '/images/project-3.webp' },
  { id: 4, title: 'Designer Shingle Upgrade', location: 'Trenton, NJ', category: 'roofing' as const, detail: 'GAF Timberline', image: '/images/project-4.webp' },
  { id: 5, title: 'Siding & Trim Package', location: 'Bucks County, PA', category: 'siding' as const, detail: 'Complete Exterior', image: '/images/project-5.webp' },
  { id: 6, title: 'Wind Damage Restoration', location: 'Baltimore, MD', category: 'storm' as const, detail: 'Emergency Repair', image: '/images/project-6.webp' },
  { id: 7, title: 'Multi-Family Roofing', location: 'Philadelphia, PA', category: 'roofing' as const, detail: 'Commercial Grade', image: '/images/project-7.webp' },
  { id: 8, title: 'Historic Home Restoration', location: 'Fredericksburg, VA', category: 'siding' as const, detail: 'Custom Match', image: '/images/project-8.webp' },
  { id: 9, title: 'Estate Roof Replacement', location: 'Montgomery County, PA', category: 'roofing' as const, detail: 'Premium Materials', image: '/images/project-9.webp' },
  { id: 10, title: 'Emergency Tree Damage Repair', location: 'Lancaster, PA', category: 'storm' as const, detail: 'Storm Response', image: '/images/project-10.webp' },
]
              ...
              >
                <div className="grid grid-cols-2">
                  ...
                  <div className="relative">
                    ...
                    <span className="absolute bottom-3 left-3 px-3 py-1 bg-guardian-blue text-white text-xs font-medium rounded-full">
                      After
                    </span>
                  </div>
                </div>
