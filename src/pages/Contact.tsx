...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'We serve PA, NJ, DE, MD, VA, and NY – anywhere within about 5 hours of our Southampton, PA headquarters. We also have a branch in Fredericksburg, VA.',
  },
]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        type="text"
                        required
                        className="w-full px-4 py-3 bg-surface border border-border rounded-xl text-navy placeholder:text-navy/30 focus:outline-none focus:ring-2 focus:ring-guardian-blue/30 focus:border-guardian-blue transition-all"
                        placeholder="John"
                      />
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        required
                        className="w-full px-4 py-3 bg-surface border border-border rounded-xl text-navy focus:outline-none focus:ring-2 focus:ring-guardian-blue/30 focus:border-guardian-blue transition-all"
                      >
                    ...
                    <div>
                      ...
                      <select className="w-full px-4 py-3 bg-surface border border-border rounded-xl text-navy focus:outline-none focus:ring-2 focus:ring-guardian-blue/30 focus:border-guardian-blue transition-all">
                  ...
                  <div>
                    ...
                    <textarea
                      rows={4}
                      className="w-full px-4 py-3 bg-surface border border-border rounded-xl text-navy placeholder:text-navy/30 focus:outline-none focus:ring-2 focus:ring-guardian-blue/30 focus:border-guardian-blue transition-all resize-none"
            ...
            >
              <div className="bg-surface rounded-2xl border border-border p-6">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    <Phone className="w-5 h-5 text-guardian-blue shrink-0 mt-0.5" />
                    <div>
                      <p className="font-medium text-navy">Call Us</p>
                      <a href="tel:855-424-5911" className="text-sm text-guardian-blue hover:underline">
                        855-424-5911
                      </a>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <Mail className="w-5 h-5 text-guardian-blue shrink-0 mt-0.5" />
                    <div>
                      <p className="font-medium text-navy">Email Us</p>
                      <a
                        href="mailto:info@guardianstormrepair.com"
                        className="text-sm text-guardian-blue hover:underline"
                      >
                  ...
                  <li className="flex items-start gap-3">
                    <MapPin className="w-5 h-5 text-guardian-blue shrink-0 mt-0.5" />
                    <div>
                  ...
                  <li className="flex items-start gap-3">
                    <Clock className="w-5 h-5 text-guardian-blue shrink-0 mt-0.5" />
                    <div>
              ...
              <div className="bg-surface rounded-2xl border border-border p-6">
                <h3 className="font-bold text-navy mb-2">Virginia Branch</h3>
                <p className="text-sm text-text-secondary">
                  Fredericksburg, VA – by appointment
                </p>
              </div>
            </motion.div>
          </div>
