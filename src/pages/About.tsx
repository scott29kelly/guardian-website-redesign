...
const values = [
  ...
  { icon: Shield, title: 'Integrity', description: "Honest advice; we'll tell you if you don't need a new roof." },
...
const team = [
  { name: 'Bobby Frehafer', title: 'Founder & Owner', image: '/images/bobby-frehafer.webp' },
...
const certs = [
  'Atlas Pro+ Diamond Level',
  'GAF Certified Weather Stopper',
  ...
  return (
    <>
      <Hero
        ...
        headline="Our"
        highlightText="Story"
        subhead="A family business built on faith, integrity, and a commitment to protecting your home."
        compact
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {values.map((v, i) => (
              ...
              >
                <div className="w-14 h-14 mx-auto mb-4 bg-guardian-blue/10 rounded-xl flex items-center justify-center">
                  <v.icon className="w-7 h-7 text-guardian-blue" />
                </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {certs.map((cert, i) => (
              ...
              >
                <Shield className="w-6 h-6 text-guardian-blue mx-auto mb-2" />
