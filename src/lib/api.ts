...
const demoResponses: Record<string, string> = {
  storm:
    "If you've noticed damage after a storm, the first step is to call us for a free inspection. We'll document everything and help you understand if you have a valid insurance claim. Call 855-424-5911 or schedule online!",
  insurance:
  ...
  schedule:
    "I'd love to help you schedule a free inspection! You can call us directly at 855-424-5911, or visit our contact page to fill out a form. We typically respond within 24 hours.",
}
