...
const certs = [
  {
    icon: Trophy,
    title: 'Atlas Pro+ Diamond',
    description: 'Elite installation program',
  },
  {
    icon: Shield,
    title: 'GAF Certified',
    description: 'Weather Stopper certified',
  },
  {
    icon: Award,
    title: 'CertainTeed Master',
    description: 'Shingle applicator certified',
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          {certs.map((cert, i) => (
            ...
            >
              <div className="w-16 h-16 mx-auto mb-4 bg-guardian-blue/10 rounded-2xl flex items-center justify-center">
                <cert.icon className="w-8 h-8 text-guardian-blue" />
              </div>
