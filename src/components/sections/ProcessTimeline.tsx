        ...
        <div ref={containerRef} className="relative max-w-2xl mx-auto">
          ...
          <div className="absolute left-8 lg:left-1/2 lg:-translate-x-px top-0 bottom-0 w-0.5 bg-border">
            <motion.div
              ...
              className="w-full bg-gradient-to-b from-guardian-blue to-safety-orange rounded-full"
            />
          </div>
            ...
            {steps.map((step, i) => (
              ...
              >
                ...
                <div className="absolute left-8 lg:left-1/2 -translate-x-1/2 z-10">
                  <div className="w-16 h-16 rounded-full bg-white border-2 border-guardian-blue shadow-lg shadow-guardian-blue/20 flex items-center justify-center">
                    <step.icon className="w-7 h-7 text-guardian-blue" />
                  </div>
                </div>
                ...
                >
                  <span className="inline-block px-2.5 py-1 bg-guardian-blue/10 text-guardian-blue text-xs font-bold rounded-full mb-2">
                    Step {i + 1}
                  </span>
