      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-3 mb-4">
              ...
              <div className="flex flex-col leading-tight">
                <span className="font-heading font-extrabold text-lg">Guardian</span>
                <span className="text-white/60 text-xs font-medium -mt-0.5">Roofing & Siding</span>
              </div>
            </Link>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-white/40">
            &copy; {new Date().getFullYear()} Guardian Roofing & Siding. All rights reserved.
          </p>
